...
export default function ChatbotDemo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-festival-magenta via-festival-blue to-festival-cyan text-white py-16 px-4">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-festival-orange">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-festival-magenta">
              <div className="text-3xl mb-3">🔍</div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-festival-blue">
              <div className="text-3xl mb-3">⚡</div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-festival-cyan">
              <div className="text-3xl mb-3">📱</div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-festival-orange mb-4">📚 Admissions</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-festival-orange mt-1">•</span>
              ...
              <div>
                <h3 className="font-bold text-festival-magenta mb-4">🎉 Events</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-festival-magenta mt-1">•</span>
              ...
              <div>
                <h3 className="font-bold text-festival-blue mb-4">📝 Exams</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-festival-blue mt-1">•</span>
              ...
              <div>
                <h3 className="font-bold text-festival-cyan mb-4">💬 Other</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-festival-blue">
            ...
            <div className="bg-red-50 rounded-lg p-6 border-l-4 border-festival-magenta">
        ...
        {/* CTA */}
        <section className="bg-gradient-to-r from-festival-orange to-festival-magenta text-white rounded-lg p-12 text-center">
          ...
          <button
            ...
            className="px-8 py-4 bg-white text-festival-magenta font-bold rounded-lg hover:bg-gray-100 transition"
          >
            Go Back to Website
          </button>
        </section>
...
function CategoryCard({ category }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition">
      {/* Card Header */}
      <div className="bg-gradient-to-r from-festival-orange to-festival-magenta p-6 text-white">
      ...
      <div className="p-6">
        <ul className="space-y-3">
          {faqs.slice(0, 3).map((faq, idx) => (
            <li key={idx} className="flex items-start gap-3 pb-3 border-b border-gray-100 last:border-0">
              <span className="text-festival-orange font-bold mt-1">Q</span>
              <div>
        ...
        {faqs.length > 3 && (
          <p className="text-sm text-festival-orange font-semibold mt-4">
