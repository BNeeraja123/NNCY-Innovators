          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-festival-blue focus:border-transparent"
              />
            </div>
        ...
        {filteredRankings.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <button
              ...
              className="mt-6 bg-festival-blue text-white font-bold py-2 px-6 rounded-lg hover:bg-opacity-90 transition"
            >
              Clear Filters
            </button>
          </div>
