...
const AnalyticsDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary via-secondary to-primary-dark py-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition">
            ...
            <p className="text-4xl font-bold text-primary">{stats.totalRankings}</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition">
            ...
            <p className="text-4xl font-bold text-secondary">{stats.totalAwards}</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition">
            ...
            <p className="text-4xl font-bold text-primary-dark">{stats.totalAchievements}</p>
