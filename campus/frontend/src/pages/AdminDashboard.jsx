            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data.attendanceTrend}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="attendance" stroke="#FF6A00" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </div>
                ...
                <div className="card">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={data.attendanceTrend}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="attendance" stroke="#FF6A00" strokeWidth={2} name="Attendance %" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
                    ...
                    <PieChart>
                      <Pie data={data.statusDistribution} cx="50%" cy="50%" labelLine={false} label={({ name, value }) => `${name}: ${value}`} outerRadius={80} fill="#8884d8" dataKey="value">
                        {data.statusDistribution.map((entry, index) => (
                          <Cell key={`cell-${index}`} fill={['#FF6A00', '#FF9A4D', '#f44336'][index]} />
                        ))}
                      </Pie>
                      <Tooltip />
                    </PieChart>
