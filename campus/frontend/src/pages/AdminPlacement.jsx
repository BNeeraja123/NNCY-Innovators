      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <aside className="lg:col-span-1">
            <QuickLinks
              onNavigate={(id) => {
                if (id === 'overview' || id === 'companies' || id === 'students') setActiveTab(id);
                if (id === 'add-company') {
        ...
        {activeTab === 'overview' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-12">
              <FeatureCard title="Total Placed" subtitle="Overall students placed" value={stats.totalPlaced} className="text-center" />
              <FeatureCard title="Companies" subtitle="Participating employers" value={stats.totalCompanies} className="text-center" />
              <FeatureCard title="Branches" subtitle="Branches represented" value={stats.uniqueBranches} className="text-center" />
              <FeatureCard title="Avg Package" subtitle="Average package (LPA)" value={stats.avgPackage} className="text-center" />
              <FeatureCard title="Highest" subtitle="Top package" value={stats.highestPackage} className="text-center" />
            </div>
        ...
        {activeTab === 'companies' && (
          <div>
            ...
            {/* Company Form */}
            {showCompanyForm && (
              <div className="bg-white p-8 rounded-lg shadow-lg mb-8 border-l-4 border-primary">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  {editingCompany ? 'Edit Company' : 'Add New Company'}
                </h3>
                <form onSubmit={handleCompanySubmit} aria-label="Company form">
                  ...
                  <div className="flex gap-4">
                    <button
                      type="submit"
                      className="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-8 rounded-lg transition"
                    >
              ...
              {filteredCompanies.map((company) => (
                <div key={company.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
                  ...
                  <div className="flex gap-2">
                    <PrimaryButton onClick={() => handleEditCompany(company)} className="flex-1 text-sm py-2">
                      Edit
                    </PrimaryButton>
                    <button
          ...
          <div>
            ...
            {showStudentForm && (
              <div className="bg-white p-8 rounded-lg shadow-lg mb-8 border-l-4 border-primary">
                ...
                <form onSubmit={handleStudentSubmit} aria-label="Student form">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <input
                      type="text"
                        ...
                        <td className="px-6 py-4">
                          <div className="flex gap-2 justify-center">
                            ...
                            <button
                              ...
                              className="bg-red-600 hover:bg-red-700 text-white font-semibold py-1 px-3 rounded transition text-xs"
                            >
                              Delete
                            </button>
                          </div>
