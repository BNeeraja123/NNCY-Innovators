...
export default function MyEvents() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-primary via-secondary to-primary-light text-white py-12 px-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-primary">{registeredEvents.length}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-primary-dark">{pastEvents.length}</p>
              </div>
              <span className="text-4xl">✅</span>
            </div>
          </div>
            ...
            {registeredEvents.length > 0 ? (
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 bg-primary text-white font-semibold py-2 px-4 rounded-lg hover:bg-opacity-90 transition"
                        >
                          Show QR Code
                        </button>
                      </div>
              ...
              <div className="text-center py-16 bg-white rounded-lg shadow-md">
                ...
                <button
                  ...
                  className="bg-secondary text-white px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition"
                >
                  Browse Events
                </button>
              </div>
            ...
            {pastEvents.filter(e => e.certificateProvided).length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {pastEvents.filter(e => e.certificateProvided).map((event) => (
                  <div key={event.id} className="bg-white rounded-lg shadow-md p-6 border-l-4 border-primary">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <button className="bg-secondary text-white px-4 py-2 rounded-lg font-semibold hover:bg-opacity-90 transition">
