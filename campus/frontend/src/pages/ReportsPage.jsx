...
const ReportsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary-light to-primary py-12">
        ...
        {viewMode === 'grid' ? (
          ...
          <div className="space-y-4">
            {reports.map((report) => (
              <div
                key={report.id}
                className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition border-l-4 border-primary"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-to-r from-primary to-secondary text-white font-bold py-2 px-6 rounded-lg hover:opacity-90 transition whitespace-nowrap flex items-center gap-2"
                  >
                    📥 Download
                  </a>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full bg-gradient-to-r from-primary to-secondary text-white font-bold py-4 px-6 rounded-lg text-center hover:opacity-90 transition text-lg"
                >
