...
const PlacedStudents = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <section className="bg-gradient-to-r from-primary via-secondary to-primary-dark py-12">
      ...
      <section className="bg-white border-b py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-gray-600 mt-4">
            Found <span className="font-bold text-primary">{filteredStudents.length}</span> student{filteredStudents.length !== 1 ? 's' : ''}
          </p>
        </div>
      </section>
            ...
            {filteredStudents.map((student) => (
              <div key={student.id} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-lg font-bold text-secondary">{student.company}</p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-primary-light">{student.batch}</p>
                  </div>
                </div>
