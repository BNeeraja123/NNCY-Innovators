...
const EventCoordinatorLogin = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  // Demo event coordinator credentials
  const DEMO_COORDINATORS = [
    { email: 'eventcoord@college.edu', password: 'eventcoord123', name: 'Event Coordinator', role: 'event_coordinator' },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (demoCoordinator) {
        ...
        setError('Invalid email or password. Demo credentials: eventcoord@college.edu / eventcoord123');
      }
    } catch (err) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-primary to-primary-light px-6 py-6">
          <h2 className="text-2xl font-bold text-white">Event Coordinator</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-blue-600 text-xs mt-1">Email: eventcoord@college.edu</p>
            <p className="text-blue-600 text-xs">Password: eventcoord123</p>
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="eventcoord@college.edu"
          ...
          <p className="text-xs text-gray-500 text-center mt-4">
            Only authorized event coordinators and admins can access this section.
          </p>
        </form>
      </div>
    </div>
...
export default EventCoordinatorLogin;
